...
public abstract class Color {
	...
	public static int getRainbowColor(int time, float saturation, float brightness, float speed) {
		float hue = (float)(time * speed)/ 360;
		int clr = java.awt.Color.HSBtoRGB(hue, saturation, brightness);
		return clr;
	}		
